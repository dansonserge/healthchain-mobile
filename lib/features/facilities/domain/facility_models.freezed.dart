...
mixin _$Facility {
  String get id;
  String get name;
  String get type; // 'pharmacy', 'hospital', 'clinic'
  double get lat;
  double get lng;
  String get address;
  String get phone;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, type, lat, lng,
      address, phone, isOpen, distanceKm, imageUrl, lastRestockDate);
