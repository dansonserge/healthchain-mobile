...
mixin _$IOTDevice {
 ...
 String get id;@JsonKey(name: 'device_id') String get hardwareId; String get name;@JsonKey(name: 'min_temp') double get minTemp;@JsonKey(name: 'max_temp') double get maxTemp; String get status;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,hardwareId,name,minTemp,maxTemp,status);
...
@useResult
$Res call({
 String id,@JsonKey(name: 'device_id') String hardwareId, String name,@JsonKey(name: 'min_temp') double minTemp,@JsonKey(name: 'max_temp') double maxTemp, String status
});
...
/// Create a copy of IOTDevice
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? hardwareId = null,Object? name = null,Object? minTemp = null,Object? maxTemp = null,Object? status = null,}) {
...
as String,minTemp: null == minTemp ? _self.minTemp : minTemp // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'device_id')  String hardwareId,  String name, @JsonKey(name: 'min_temp')  double minTemp, @JsonKey(name: 'max_temp')  double maxTemp,  String status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _IOTDevice() when $default != null:
return $default(_that.id,_that.hardwareId,_that.name,_that.minTemp,_that.maxTemp,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'device_id')  String hardwareId,  String name, @JsonKey(name: 'min_temp')  double minTemp, @JsonKey(name: 'max_temp')  double maxTemp,  String status)  $default,) {final _that = this;
switch (_that) {
case _IOTDevice():
return $default(_that.id,_that.hardwareId,_that.name,_that.minTemp,_that.maxTemp,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'device_id')  String hardwareId,  String name, @JsonKey(name: 'min_temp')  double minTemp, @JsonKey(name: 'max_temp')  double maxTemp,  String status)?  $default,) {final _that = this;
switch (_that) {
case _IOTDevice() when $default != null:
return $default(_that.id,_that.hardwareId,_that.name,_that.minTemp,_that.maxTemp,_that.status);case _:
  return null;
...
class _IOTDevice implements IOTDevice {
  const _IOTDevice({required this.id, @JsonKey(name: 'device_id') required this.hardwareId, required this.name, @JsonKey(name: 'min_temp') required this.minTemp, @JsonKey(name: 'max_temp') required this.maxTemp, required this.status});
  factory _IOTDevice.fromJson(Map<String, dynamic> json) => _$IOTDeviceFromJson(json);

@override final  String id;
@override@JsonKey(name: 'device_id') final  String hardwareId;
...
/// Create a copy of IOTDevice
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? hardwareId = null,Object? name = null,Object? minTemp = null,Object? maxTemp = null,Object? status = null,}) {
...
mixin _$TelemetryData {
 ...
 double get temperature; DateTime get timestamp;@JsonKey(name: 'is_critical') bool get isCritical;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TelemetryData&&(identical(other.temperature, temperature) || other.temperature == temperature)&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp)&&(identical(other.isCritical, isCritical) || other.isCritical == isCritical));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,temperature,timestamp,isCritical);
...
@useResult
$Res call({
 double temperature, DateTime timestamp,@JsonKey(name: 'is_critical') bool isCritical
});
...
/// Create a copy of TelemetryData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? temperature = null,Object? timestamp = null,Object? isCritical = null,}) {
  return _then(_self.copyWith(
temperature: null == temperature ? _self.temperature : temperature // ignore: cast_nullable_to_non_nullable
as double,timestamp: null == timestamp ? _self.timestamp : timestamp // ignore: cast_nullable_to_non_nullable
as DateTime,isCritical: null == isCritical ? _self.isCritical : isCritical // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double temperature,  DateTime timestamp, @JsonKey(name: 'is_critical')  bool isCritical)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TelemetryData() when $default != null:
return $default(_that.temperature,_that.timestamp,_that.isCritical);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double temperature,  DateTime timestamp, @JsonKey(name: 'is_critical')  bool isCritical)  $default,) {final _that = this;
switch (_that) {
case _TelemetryData():
return $default(_that.temperature,_that.timestamp,_that.isCritical);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double temperature,  DateTime timestamp, @JsonKey(name: 'is_critical')  bool isCritical)?  $default,) {final _that = this;
switch (_that) {
case _TelemetryData() when $default != null:
return $default(_that.temperature,_that.timestamp,_that.isCritical);case _:
  return null;
...
class _TelemetryData implements TelemetryData {
  const _TelemetryData({required this.temperature, required this.timestamp, @JsonKey(name: 'is_critical') required this.isCritical});
  factory _TelemetryData.fromJson(Map<String, dynamic> json) => _$TelemetryDataFromJson(json);

@override final  double temperature;
@override final  DateTime timestamp;
@override@JsonKey(name: 'is_critical') final  bool isCritical;
...
@override
Map<String, dynamic> toJson() {
  return _$TelemetryDataToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TelemetryData&&(identical(other.temperature, temperature) || other.temperature == temperature)&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp)&&(identical(other.isCritical, isCritical) || other.isCritical == isCritical));
}
...
/// Create a copy of TelemetryData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? temperature = null,Object? timestamp = null,Object? isCritical = null,}) {
...
mixin _$NotificationItem {
 ...
 String get id; String get title; String get message; String get type; String get status;@JsonKey(name: 'created_at') DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,message,type,status,createdAt);
...
@useResult
$Res call({
 String id, String title, String message, String type, String status,@JsonKey(name: 'created_at') DateTime createdAt
});
...
/// Create a copy of NotificationItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? message = null,Object? type = null,Object? status = null,Object? createdAt = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String message,  String type,  String status, @JsonKey(name: 'created_at')  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationItem() when $default != null:
return $default(_that.id,_that.title,_that.message,_that.type,_that.status,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String message,  String type,  String status, @JsonKey(name: 'created_at')  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _NotificationItem():
return $default(_that.id,_that.title,_that.message,_that.type,_that.status,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String message,  String type,  String status, @JsonKey(name: 'created_at')  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _NotificationItem() when $default != null:
return $default(_that.id,_that.title,_that.message,_that.type,_that.status,_that.createdAt);case _:
  return null;
...
class _NotificationItem implements NotificationItem {
  const _NotificationItem({required this.id, required this.title, required this.message, required this.type, required this.status, @JsonKey(name: 'created_at') required this.createdAt});
...
/// Create a copy of NotificationItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? message = null,Object? type = null,Object? status = null,Object? createdAt = null,}) {
